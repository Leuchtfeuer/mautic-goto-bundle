...
final class GoToEvents
{
     ...
     * @var string
     */
    const ON_GOTO_WEBINAR_EVENT = 'mautic.on_citrix_webinar_event';
     ...
     * @var string
     */
    const ON_GOTO_MEETING_EVENT = 'mautic.on_citrix_meeting_event';
     ...
     * @var string
     */
    const ON_GOTO_TRAINING_EVENT = 'mautic.on_citrix_training_event';
     ...
     * @var string
     */
    const ON_GOTO_ASSIST_EVENT = 'mautic.on_citrix_assist_event';
     ...
     * @var string
     */
    const ON_GOTO_WEBINAR_ACTION = 'mautic.on_citrix_webinar_action';
     ...
     * @var string
     */
    const ON_GOTO_MEETING_ACTION = 'mautic.on_citrix_meeting_action';
     ...
     * @var string
     */
    const ON_GOTO_TRAINING_ACTION = 'mautic.on_citrix_training_action';
     ...
     * @var string
     */
    const ON_GOTO_ASSIST_ACTION = 'mautic.on_citrix_assist_action';
     ...
     * @var string
     */
    const ON_GOTO_REGISTER_ACTION = 'mautic.on_webinar_register_action';
     ...
     * @var string
     */
    const ON_GOTO_TOKEN_GENERATE = 'mautic.on_citrix_token_generate';
     ...
     * @var string
     */
    const ON_GOTO_EVENT_UPDATE = 'mautic.on_citrix_event_update';
}
