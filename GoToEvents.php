 ...
 * Class GoToEvents.
 *
 * Events available for LeuchtfeuerGoToBundle
 */
final class GoToEvents
{
     ...
     *
     * The event listener receives a MauticPlugin\LeuchtfeuerGoToBundle\Event\TokenGenerateEvent instance.
     *
     * @var string
     */
     ...
     *
     * The event listener receives a MauticPlugin\LeuchtfeuerGoToBundle\Event\GoToEventUpdateEvent instance.
     *
     * @var string
     */
